...
function setup() {
	...
	rect1s.shapeColor=color("white");

	rect2s = createSprite(300,600,20,120);
	rect2s.shapeColor =color("white");

	rect3s = createSprite(500,600,20,120);
	rect3s.shapeColor =color("white");
